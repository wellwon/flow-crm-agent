      ...
      <div className="flex gap-4 min-w-max h-full">
        {columns.map(col => {
          ...
          return (
            <div
              key={col.status}
              className={`w-[260px] flex flex-col rounded-xl transition-colors ${
            ...
            >
              ...
              <div className="flex-1 space-y-2 overflow-y-auto pr-1 px-1">
                {colNodes.map(node => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-xl glass-panel cursor-grab active:cursor-grabbing hover:border-primary/20 transition-all group ${
                ...
                {colNodes.length === 0 && (
                  <div className="flex items-center justify-center h-20 rounded-xl border border-dashed border-border/30 text-[10px] text-muted-foreground/40">
                    Перетащите сюда
                  </div>
                )}
              </div>
