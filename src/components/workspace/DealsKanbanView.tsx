            ...
            <div className="flex-1 flex flex-col gap-2">
              {colDeals.map((deal) => (
                <div
                  ...
                  className="rounded-xl border border-border/30 bg-card/50 backdrop-blur-sm p-3.5 cursor-pointer hover:border-primary/30 hover:bg-primary/5 transition-all group"
                >
